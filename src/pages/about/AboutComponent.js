...
export function AboutComponent (){
    ...
    <div className='aboutWrapper'>
        <div className='aboutWrapperWrapper'>
            ...
            :
            localStorage.getItem('language') === "IT" ? <p>Con <strong>15 anni</strong> di esperienza nella produzione di mobili in legno e <strong>70 colleghi dedicati</strong>, abbiamo cambiato il nostro focus su una nuova attività - la produzione di <strong>pellets</strong> e <strong>briquettes</strong>. Durante una vacanza in Grecia, abbiamo incontrato una persona che ci ha ispirato a portare in Romania una macchina che trasforma <strong>rami secchi in trucioli di legno</strong>. Dopo ricerche, abbiamo scoperto che questi trucioli di legno possono essere trasformati in <strong>pellets</strong> e <strong>briquettes</strong>, prodotti molto richiesti sul mercato.</p>
            :
            localStorage.getItem('language') === "DE" ? <p>Mit <strong>15 Jahren</strong> Erfahrung in der Herstellung von Holzmöbeln und <strong>70 engagierten Kollegen</strong> haben wir uns auf ein neues Geschäftsfeld konzentriert - die Produktion von <strong>Pellets</strong> und <strong>Briketts</strong>. Während eines Urlaubs in Griechenland trafen wir jemanden, der uns inspirierte, eine Maschine, die <strong>getrocknete Äste in Holzspäne</strong> verwandelt, nach Rumänien zu bringen. Nach Recherchen stellten wir fest, dass diese Holzspäne in <strong>Pellets</strong> und <strong>Briketts</strong> umgewandelt werden können, Produkte, die auf dem Markt sehr gefragt sind.</p>
:
            localStorage.getItem('language') === "FR" ? <p>Avec <strong>15 ans</strong> d'expérience dans la fabrication de meubles en bois et <strong>70 collègues dévoués</strong>, nous nous sommes concentrés sur une nouvelle entreprise : la production de <strong>pellets</ strong> et <strong>briquettes</strong>. Lors de vacances en Grèce, nous avons rencontré quelqu'un qui nous a inspiré pour apporter une machine qui transforme les <strong>branches sèches en copeaux de bois</strong> en Roumanie. Après recherche, nous avons découvert que ces copeaux de bois pouvaient être transformés en <strong>pellets et briquettes</strong>, des produits très demandés sur le marché.</p>
